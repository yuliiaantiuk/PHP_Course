...
*/
$fahrenheitToCelsius = fn($farTemp) => ($farTemp - 32) * 5/9;
$degree = 32;
echo $degree . '&degF = ' . $fahrenheitToCelsius($degree) . '&degC';
echo '<br>';
...
echo findLongestWord("The cutest quick brown fox jumps over a lazy lying dog");
